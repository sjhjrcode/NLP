...
sentances.append("hello yes:SN")
sentances.append("hello no:SN")
...
sentances.append("hello negative:SN")
sentances.append("hello positive:SN")
...
sentances.append("hello correct:SN")
sentances.append("hello incorrect:SN")
...
sentances.append("hello start camera:CC")
sentances.append("hello stop camera:CC")
sentances.append("hello open camera:CC")
...
sentances.append("hello rewind video:VC")
sentances.append("hello pause video:VC")
sentances.append("hello skip forward:VC")
