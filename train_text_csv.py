...
sentances.append("pause the video:VC")
sentances.append("Stop the video:VC")
sentances.append("Pause:VC")
sentances.append("Freeze video:VC")
sentances.append("Stop video:VC")
sentances.append("Freeze video:VC")
sentances.append("Press pause:VC")
sentances.append("can you start the video:VC")
sentances.append("Resume the video:VC")
sentances.append("Play:VC")
sentances.append("Play video:VC")
sentances.append("Continue video:VC")
sentances.append("Unfreeze video:VC")
sentances.append("Replay video:VC")
sentances.append("Play video :VC")
sentances.append("Press play :VC")
sentances.append("play it back:VC")
sentances.append("Go back a few seconds:VC")
sentances.append("Turn back video:VC")
sentances.append("Reverse video:VC")
sentances.append("Restart video:VC")
sentances.append("Go back on the video:VC")
sentances.append("Go back:VC")
sentances.append("Minus 15 seconds :VC")
sentances.append("skip forward in the video:VC")
sentances.append("Next video:VC")
sentances.append("Fast forward :VC")
sentances.append("Skip video:VC")
sentances.append("Pass video:VC")
sentances.append("Speed up video:VC")
sentances.append("Skip:VC")
sentances.append("Skip forward 30 seconds :VC")
sentances.append("Go forward:VC")
